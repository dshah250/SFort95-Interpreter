...
extern bool Decl(istream& in, int& line); //done (prob wrong)
extern bool Type(istream& in, int& line); //done (wrong)
extern bool VarList(istream& in, int& line); //done
extern bool Stmt(istream& in, int& line); //done (check the if part) (prob wrong)
extern bool SimpleStmt(istream& in, int& line); //done
extern bool PrintStmt(istream& in, int& line); //done
extern bool BlockIfStmt(istream& in, int& line); //done (might be wrong)
